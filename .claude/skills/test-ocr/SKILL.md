...
- Khi skill nay duoc load:
  - dung `CLAUDE.md`, muc `Vong lap kiem thu OCR bat buoc` lam source of truth duy nhat cho workflow
  - neu can relay sang Codex, dung them `CLAUDE.md`, muc `Quy trinh Claudex - Lam viec voi Codex`, phan `Relay OCR giua Claude va Codex`
- Khong dinh nghia lai workflow chi tiet o day. Neu co mau thuan, uu tien `CLAUDE.md`.
