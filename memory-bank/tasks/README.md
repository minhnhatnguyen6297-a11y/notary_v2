...
Create one file per substantial active task only when the compact dashboard is
not enough for safe recovery. `CURRENT.md` links the records that matter now;
Git retains removed or replaced history.
